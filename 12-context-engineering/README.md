...
- [OpenAI: Conversation State](https://platform.openai.com/docs/guides/conversation-state) — state management
- ["Lost in the Middle"](https://arxiv.org/abs/2307.03172) — the U-shaped attention paper
